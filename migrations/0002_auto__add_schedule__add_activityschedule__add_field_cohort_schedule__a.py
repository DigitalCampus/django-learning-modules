...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('learning_modules_schedule', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('learning_modules', ['Schedule'])

        # Adding model 'ActivitySchedule'
        db.create_table('learning_modules_activityschedule', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('schedule', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['learning_modules.Schedule'])),
        ...
        db.send_create_signal('learning_modules', ['ActivitySchedule'])

        # Adding field 'Cohort.schedule'
        db.add_column('learning_modules_cohort', 'schedule',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('learning_modules_schedule')

        # Deleting model 'ActivitySchedule'
        db.delete_table('learning_modules_activityschedule')

        # Deleting field 'Cohort.schedule'
        db.delete_column('learning_modules_cohort', 'schedule_id')
