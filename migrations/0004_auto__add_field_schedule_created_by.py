...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Schedule.created_by'
        db.add_column('learning_modules_schedule', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Schedule.created_by'
        db.delete_column('learning_modules_schedule', 'created_by_id')
