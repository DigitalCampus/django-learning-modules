...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tracker.completed'
        db.add_column('learning_modules_tracker', 'completed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tracker.completed'
        db.delete_column('learning_modules_tracker', 'completed')
    ...
    models = {
        ...
        'learning_modules.tag': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'module': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['learning_modules.Module']", 'symmetrical': 'False'}),
