...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tracker.time_taken'
        db.add_column('learning_modules_tracker', 'time_taken',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tracker.time_taken'
        db.delete_column('learning_modules_tracker', 'time_taken')
