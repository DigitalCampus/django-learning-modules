...
from learning_modules.api.resources import TrackerResource, ModuleResource, ScheduleResource
...
urlpatterns = patterns('',
    ...
    url(r'^(?P<module_id>\d+)/schedule/$', 'learning_modules.views.schedule', name="module_schedule"),
